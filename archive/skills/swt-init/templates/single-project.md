...
This project uses the **Simple Workflow Toolkit (SWT)** for methodology enforcement. All behavioral rules, workflow protocols, and project context are defined in this document and enforced via the `/swt:flow` orchestrator.
